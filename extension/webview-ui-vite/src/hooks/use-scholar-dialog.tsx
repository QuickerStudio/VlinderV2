...
import { ScholarDialogState, ScholarDialogActions } from "@/components/chat-view/scholar-dialog"
...
export const useScholarDialog = (): UseScholarDialogReturn => {
	...
	const sendQuestion = useCallback(async (onResponseReceived: (response: string) => void) => {
