...
const nodeTypes: NodeTypeConfig[] = [
  ...
  { value: 'circle', label: 'Circle', icon: '●', description: 'Circle node' },
  {
    ...
    label: 'Stadium',
    icon: '⬭',
    description: 'Stadium/capsule shaped node',
  },
  {
    value: 'subroutine',
    label: 'Subroutine',
    icon: '⬜',
    description: 'Subroutine/process node',
  },
  {
    value: 'cylindrical',
    label: 'Database',
  ...
  },
  {
    ...
    label: 'Parallel',
    icon: '▱',
    description: 'Parallelogram node',
  },
  {
    value: 'trapezoid',
    label: 'Trapezoid',
    icon: '⏢',
    description: 'Trapezoid node',
  },
  {
    value: 'doubleCircle',
    label: 'Double Circle',
  ...
  },
  {
    ...
    label: 'Image',
    icon: '🖼️',
    description: 'Image node - Upload and display images',
  },
  {
    value: 'text',
    label: 'Text',
    icon: '📝',
    description: 'Text node - Interface description text',
  },
  {
    value: 'button',
    label: 'Button',
    icon: '🔘',
    description: 'Button node - Interactive buttons and function descriptions',
  },
];
    ...
    >
      ...
      <div className='flex flex-col gap-2'>
        ...
        <button
          ...
          title={
            isPanMode ? 'Exit Pan Mode' : 'Enter Pan Mode - Drag to move canvas'
          }
        >
        ...
        <button
          ...
          title={
            isEdgeEditMode ? 'Exit Edge Edit Mode' : 'Enter Edge Edit Mode'
          }
        >
