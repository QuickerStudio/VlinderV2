import { templateCategories, type MermaidTemplate } from '../hooks/mermaid-templates'
	...
	return (
		<div className="relative template-dropdown-container">
			...
			>
				...
				<span className={`codicon codicon-chevron-${showTemplateDropdown ? 'up' : 'down'} hidden lg:inline`}></span>
			</button>
					...
					<div className="max-h-64 overflow-y-auto">
						{filteredTemplates.map(template => (
							...
							>
								...
								<div className="text-xs text-primary mt-1">{template.category}</div>
							</button>
						))}
					</div>
				</div>
