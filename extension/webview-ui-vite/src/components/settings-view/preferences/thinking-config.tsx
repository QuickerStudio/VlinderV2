...
export const ThinkingConfigComponent: React.FC<
  ThinkingConfigComponentProps
> = ({ modelId }) => {
      ...
      <CardContent className='space-y-6'>
        ...
        <div className='space-y-4'>
          ...
          <p className='text-xs text-muted-foreground'>
            Adjust the slider to set the token budget for thinking (range:{' '}
            {MIN_BUDGET.toLocaleString()} - {MAX_BUDGET.toLocaleString()}{' '}
            tokens)
          </p>
        </div>
      </CardContent>
