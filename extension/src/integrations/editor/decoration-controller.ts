...
export const DIFF_VIEW_URI_SCHEME = 'diff';
export const MODIFIED_URI_SCHEME = 'modified';
export const INLINE_DIFF_VIEW_URI_SCHEME = 'inline-diff';
export const INLINE_MODIFIED_URI_SCHEME = 'inline-modified';

export const fadedOverlayDecorationType =
...
export const activeLineDecorationType =
	vscode.window.createTextEditorDecorationType({
