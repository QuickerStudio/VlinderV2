...
`
	 ...
	 * @param customSystemPrompt - Custom system prompt options
	 * @param skipProcessing - Whether to skip conversation history processing
	 * @param postProcessConversationCallback - Callback after processing conversation
	 * @param silent - Whether to suppress UI status updates (for background operations)
