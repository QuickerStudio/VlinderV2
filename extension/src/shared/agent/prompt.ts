...
> = {
	thinking: {
		description:
			'Insert a thinking block if the agent is has reasoning capabilities enabled',
	},
	vision: {
	...
	osName: {
		description:
			'The operating system the agent is running on (e.g., Windows, Linux, macOS)',
	},
	defaultShell: {
		description:
			'The default shell used by the system (e.g., bash, powershell)',
	},
	homeDir: {
